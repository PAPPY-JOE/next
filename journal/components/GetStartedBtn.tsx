...
const GetStartedBtn = () => {
  return (
    <button className="group bg-gradient-to-r from-[#4c4e52] from-10% to-[#000302] to-100% px-4 rounded-full text-lg flex items-center w-full max-w-[300px] relative h-10">
